...
In questo, si deve aver padronanza sia dei dettagli tecnici dei protocolli, i pacchetti, ecc... (quindi le richieste che si trovano in manuali e **RFC**, *Request For Comments*) che conoscenze *hands-on* riguardo a come effettivamente operare con router, switch, ecc...
Questo è motivato dal fatto che per avere effettivamente gestione ottimale dei flussi di dati non ci si può affidare ad una data teoria, ma si devono avere conoscenze pratiche date dall'esperienza (capacità di *troubleshooting*, ecc...).
Vediamo ad esempio che alcuni dei requisiti sopra riportati (ad esempio l'*affidabilità*) non sono *funzionali*: non sono di sistemi di per sé soltanto corretti, ma di sistemi corretti e che assicurano certe caratteristiche quando vengono messi in operazione (*affidabilità* significa sistemi che non solo gestiscono gli errori ma assicurano che questi non avvengano o abbiano impatto minimo).
