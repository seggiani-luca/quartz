...
Come tutti i computer, quindi, i router sono dotati di memoria, CPU, e loro particolarità, un sistema di I/O estremamente specializzato (ed estremamente veloce) composto dalle porte di ingresso e uscita (solitamente di tipo Ethernet) su cui viaggiano i pacchetti.  Vediamo ad esempio il *backplane* di un router Cisco serie 1800 per vedere il tipo di interfacce di cui ha bisogno:
