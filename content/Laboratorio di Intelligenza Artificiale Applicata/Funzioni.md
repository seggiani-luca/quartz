...
- `global` riporta il namespace a quello più esterno, cioè quello globale.
Notiamo che, come abbiamo detto nella sezione precedente, la visibilità delle variabili di default è quella più locale. 
### Argomenti
